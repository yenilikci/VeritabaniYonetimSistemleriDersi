...
<div class="col-lg-10">
       ...
       <?php 
        ...
        <!--Uyarı son.--> 
          ...
          <!--Yabancı Diller tablosunun çekimi-->
          <?php
              $yabancidil_id = $_GET["yabancidil_id"];
              #tablodan verileri çekme
              $sorgu = $db->prepare("SELECT *FROM yabancidil_yeteneklerim WHERE yabancidil_id=?");
              #WHERE $beceri_id=? yazıyorum ki bu sayfada bu veriyi güncelleyeceğimi işleme söyleyeyim.
              $sorgu->execute(array($yabancidil_id));
              $yabancidilcek = $sorgu->fetch(PDO::FETCH_ASSOC);
        ?>
                    ...
                    <div class="card bg-dark text-white mb-3 mt-3 icerik">
                      <div class="card-header ustbilgi"><i class="fas fa-cog mx-2"></i>Yabancı Dil Düzenle</div>
                      <div class="card-body">
                        <h5 class="card-title text-warning">Yabancı Dil Düzenle Bölümüne Hoş Geldiniz!
                          Buradan Yabancı Dillerinizi Düzenleyebilirsiniz.
                        </h5>

                        <form class="form-horizontal" role="form" action="islem.php?yabancidil_id=<?php echo $yabancidilcek["yabancidil_id"];?>" method="POST">

										  <div class="form-group">
										    <label for="inputEmail3" class="col-sm-2 control-label">Beceri Adı</label>
										    <div class="col-sm-12">
										      <input name="yabancidil_isim" type="text" class="form-control" value="<?php echo $yabancidilcek["yabancidil_isim"]; ?>">
										    </div>
                      </div>
                      ...
                      <div class="form-group">
										    ...
										    <div class="col-sm-12">
										      <input name="yabancidil_yuzde" type="text" class="form-control" value="<?php echo $yabancidilcek["yabancidil_yuzde"]; ?>">
										    </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <button name="yabancidil-duzenle" class="btn btn-success pull-right">Güncelle</button>
                      </div>
