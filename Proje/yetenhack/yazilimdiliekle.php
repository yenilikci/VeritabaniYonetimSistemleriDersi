       ...
       <?php 
        ...
        <!--Uyarı son.--> 
                    ...
                    <div class="card bg-dark text-white mb-3 mt-3 icerik">
                      <div class="card-header ustbilgi"><i class="fas fa-cog mx-2"></i>Yazılım Dili Ekle</div>
                      <div class="card-body">
                        <h5 class="card-title text-warning">Yazılım Dili Ekle Bölümüne Hoş Geldiniz!
                          Buradan Hakim Olduğunuz Yazılım Dillerini Ekleyebilirsiniz.
                        </h5>

                        <form class="form-horizontal" role="form" action="islem.php" method="POST">

										  <div class="form-group">
										    <label for="inputEmail3" class="col-sm-2 control-label">Yazılım Dili Adı</label>
										    <div class="col-sm-12">
										      <input name="yazilimdiliyetenek_adi" type="text" class="form-control" placeholder="Yazılım Dili Adını Giriniz">
										    </div>
                      </div>
                      
                      <div class="form-group">
										    <label for="inputEmail3" class="col-sm-2 control-label">Yazılım Dili Yüzde (%)</label>
										    <div class="col-sm-12">
										      <input name="yazilimdiliyetenek_yuzde" type="text" class="form-control" placeholder="Hakim Olma Yüzdenizi Giriniz">
										    </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <button name="yazilimdili-ekle" class="btn btn-success pull-right">Ekle</button>
                      </div>
