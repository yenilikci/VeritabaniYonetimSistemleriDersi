       ...
       <?php 
        ...
        <!--Uyarı son.--> 
                    ...
                    <div class="card bg-dark text-white mb-3 mt-3 icerik">
                      ...
                      <div class="card-body">
                        ...
                        <form class="form-horizontal" role="form" action="islem.php" method="POST">
										  ...
										  <div class="form-group">
										    <label for="inputEmail3" class="col-sm-2 control-label">Program Adı</label>
										    <div class="col-sm-12">
										      <input name="paketprogrambilgisi_adi" type="text" class="form-control" placeholder="Program Adını Giriniz">
										    </div>
                      </div>
                      
                      <div class="form-group">
										    <label for="inputEmail3" class="col-sm-2 control-label">Program Hakimiyet Yüzde (%)</label>
										    <div class="col-sm-12">
										      <input name="paketprogrambilgisi_yuzde" type="text" class="form-control" placeholder="Program Hakimiyet Yüzdesini Giriniz">
										    </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <button name="paketprogram-ekle" class="btn btn-success pull-right">Ekle</button>
                      </div>
